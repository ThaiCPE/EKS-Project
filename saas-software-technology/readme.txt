...
= 0.1.1 =
* Done prefixing in some files.
* Added load_theme_textdomain() in funtion.php file.
* Added google font license in readme.txt file.
* Done escaping correctly.
...
* Resolved css error for slider content in mobile media.
* Update POT file.
...
* Resolved css error for slider content in tablet media.
* Resolved css error for carousel next prev buttons in tablet media.
...
* Resolved css error for woocommerce page.
* Update POT file.
...
= 0.4.4 =
* Added premium features information in header section,about section and post setting.
...
* Resolved css error for menu color in header.
* Tested upto WP v6.6
* Update POT file.
...
= 0.5.9 =
* Resolved excerpt length error in post settings and single post settings .
* Added toggle button background color option in mobile media.
...
* Resolved error in footer widget responsive media.
* Resolved css error in single product page.
* Update POT file.

= 0.6.5 =
* Added button hover effect option in customizer.
* Resolved css error in slider responsive media.
* Resolved css error in customizer.
* Update POT file.
...
SAAS Software Technology WordPress Theme, Copyright 2022 ThemesCaliber
SAAS Software Technology is distributed under the terms of the GNU GPL
...
- Pxhere Images
	...
	Slider image, Copyright Mohamed Hassan
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pxhere.com/en/photo/1443941

	Slider image, Copyright Mohamed Hassan
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pxhere.com/en/photo/1449121

	Slider image, Copyright Mohamed Hassan
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pxhere.com/en/photo/1439097

	Slider image, Copyright Mohamed Hassan
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pxhere.com/en/photo/1401524

    About image, Copyright rawpixel.com
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pxhere.com/en/photo/1559499

    About image, Copyright rawpixel.com 
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pxhere.com/en/photo/1535227